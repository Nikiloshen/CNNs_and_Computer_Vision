...
from copy import deepcopy # In order to copy a dict you have to do deepcopy
import pandas as pd
import constants
...
def main():
    ...
    player_stats_data = [{
        ...
        'player_2_play_style': None
    }]
    
    speed_of_opponent_total = 0
    for ball_shot_ind in range(len(ball_shot_frames)-1): 
        ...
        speed_of_opponent = distance_covered_by_opponent_in_meters/ball_shot_time_in_seconds * 3.6
        ...
        speed_of_opponent_total += speed_of_opponent
        current_player_stats[f'player_{opponent_player_id}_total_player_speed'] = speed_of_opponent_total
        current_player_stats[f'player_{opponent_player_id}_last_player_speed'] = speed_of_opponent

        current_player_stats[f'player_{opponent_player_id}_play_style'] = 'Aggressive' if (speed_of_opponent_total > current_player_stats[f'player_{opponent_player_id}_total_player_speed'] or current_player_stats[f'player_{opponent_player_id}_total_shot_speed'] > current_player_stats[f'player_{opponent_player_id-1 if opponent_player_id == 2 else opponent_player_id+1}_total_shot_speed']) else 'Defensive'
